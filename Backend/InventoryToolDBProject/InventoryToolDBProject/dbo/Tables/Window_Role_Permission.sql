CREATE TABLE [dbo].[Window_Role_Permission] (
    ...
    CONSTRAINT [FK_Window_Role_Permission_M_Role] FOREIGN KEY ([Role_Id]) REFERENCES [dbo].[M_Role] ([Role_Id]),
    CONSTRAINT [FK_Window_Role_Permission_M_Window] FOREIGN KEY ([Window_Id]) REFERENCES [dbo].[M_Window] ([Window_Id])
);
